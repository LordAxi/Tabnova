...
function domainfieldupdate() {
  ...
  if (searchengine === "google") {
    document.getElementById("searchengine").action =
...
`
  ...
  document.getElementById("welcome-phrase").innerHTML = document.getElementById(
    "welcome-phrase-input"
  ).value;
  document.getElementById("welcome-phrase").style.color =
    document.getElementById("welcome-color").value;
  document.getElementById("welcome-phrase").style.fontFamily =
    document.getElementById("welcome-font").value;
  document.getElementById("welcome-phrase").style.fontSize =
    document.getElementById("welcome-size").value;
